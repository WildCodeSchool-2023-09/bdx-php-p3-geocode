 ...
 */
final class Version20240206133450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, terminal_id INT DEFAULT NULL, user_id INT DEFAULT NULL, datetime_start DATETIME NOT NULL, date_time_end DATETIME NOT NULL, INDEX IDX_E00CEDDEE77B6CE8 (terminal_id), INDEX IDX_E00CEDDEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, brand VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, outlet_type VARCHAR(50) NOT NULL, picture VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_773DE69DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE terminal (id INT AUTO_INCREMENT NOT NULL, town_id INT DEFAULT NULL, point POINT NOT NULL COMMENT \'(DC2Type:point)\', address VARCHAR(255) NOT NULL, outlet_type VARCHAR(255) NOT NULL, number_outlet INT NOT NULL, max_power INT NOT NULL, INDEX IDX_8F7B154175E23604 (town_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE town (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, zip_code VARCHAR(255) NOT NULL, point POINT NOT NULL COMMENT \'(DC2Type:point)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
